...
public class PsithurismPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> ONSEN_WATER_LAKE = create("onsen_water_lake");
	...
	public static void register(AdvancedContainer mod) {
		...
		BiomeModifications.addFeature(BiomeSelectors.includeByKey(Biomes.CHERRY_GROVE), GenerationStep.Decoration.TOP_LAYER_MODIFICATION, FLOWER_DARK_CHERRY);
		BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Decoration.LAKES, ONSEN_WATER_LAKE);
	}
}
